...
export const metadata: Metadata = {
  title: 'Blog | Shopify, AI & operations | AI Clawers',
  description:
    'English field notes on Shopify development, Storefront MCP, AI Toolkit, store operations, and practical AI for merchants and teams.',
};
