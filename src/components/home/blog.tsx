      ...
      <div className="main-container space-y-8 md:space-y-14">
        <div className="space-y-4 text-center max-md:pb-4">
          <TextReveal>
            ...
            >
              Shopify build notes <span className="text-white/30">and practical AI</span>
            </h2>
          </TextReveal>

          <TextReveal delay={0.2}>
            <p className="font-inter-tight text-tagline-2 mx-auto max-w-xl text-white/60">
              Field notes on themes, apps, performance, and copilots—written for merchants and the
              teams shipping beside them.
            </p>
          </TextReveal>
        </div>
        ...
        <RevealAnimation delay={0.1}>
          <div className="flex justify-center max-md:mt-3">
            <PrimaryLinkButton href="/blog">Browse the blog</PrimaryLinkButton>
          </div>
        </RevealAnimation>
      </div>
    </section>
